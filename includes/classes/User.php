...
class User extends Database
{
	...
	{
		$sql = "SELECT `userid`,`passwort` FROM `user` WHERE `username`='" . $this->escapeString($username) . "'";
	...
	public static function createUser($data)
	{
		...
		$sql = "INSERT INTO `user`(`username`,`passwort`,`vorname`,`email`) VALUES('".$username."','".$password."','".$firstname."','".$email."')";
		$db->query($sql);
	}
